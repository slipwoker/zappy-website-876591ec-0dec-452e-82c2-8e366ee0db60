        ...
        function handleFormSubmit(e) {
            ...
            inputs.forEach(function(input) {
                if (input.hasAttribute('required') && !input.value.trim()) {
                    ...
                    msg.textContent = input.getAttribute('data-error') || 'This field is required';
                ...
                if (input.type === 'email' && input.value.trim()) {
                    ...
                    if (!emailRegex.test(input.value.trim())) {
                        ...
                        var msg = document.createElement('span');
                        msg.className = 'error-message';
                        msg.textContent = input.getAttribute('data-error-email') || 'Please enter a valid email';
                        input.parentNode.appendChild(msg);
                        if (!firstInvalid) firstInvalid = input;
                    }
                }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '876591ec-0dec-452e-82c2-8e366ee0db60',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '876591ec-0dec-452e-82c2-8e366ee0db60';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '876591ec-0dec-452e-82c2-8e366ee0db60';
